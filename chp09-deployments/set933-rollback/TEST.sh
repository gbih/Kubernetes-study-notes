...
#echo "Wait for a pod to start up"
...
#echo "kubectl patch deployment kubia -p '{\"spec\": {\"minReadySeconds\": 3}}' -n=chp09-set933"
#kubectl patch deployment kubia -p '{"spec": {"minReadySeconds": 3}}' -n=chp09-set933
#echo ""
