...
echo "Tests for Section 17.9 Termination Message" 
echo ""
...
echo "kubectl get pods -n=chp17-set179 -o wide"
kubectl get pods -n=chp17-set179 -o wide
echo ""

#kubectl describe pod/pod-with-termination-message -n=chp17-set179
#echo ""

echo "kubectl -n=chp17-set179 exec -it pod-with-termination-message -- cat /var/termination-reason"
kubectl -n=chp17-set179 exec -it pod-with-termination-message -- cat /var/termination-reason

echo $HR

kubectl -n=chp17-set179 cp pod-with-termination-message:/var/termination-reason termination-reason
echo ""


echo "kubectl describe pods -n=chp17-set179"
kubectl describe pods -n=chp17-set179
