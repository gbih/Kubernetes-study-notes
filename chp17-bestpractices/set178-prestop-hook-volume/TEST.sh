...
echo "Tests for Section 17.8 pre-stop hook volume" 
echo ""
...
echo "kubectl get pods -n=chp17-set178 -o wide"
kubectl get pods -n=chp17-set178 -o wide
echo ""

kubectl describe pod/pod-with-prestop-hook -n=chp17-set178
echo ""
