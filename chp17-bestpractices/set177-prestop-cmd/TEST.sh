...
echo "Tests for Section 17.7 pre-stop hook command"
echo ""
...
echo "kubectl get pods -n=chp17-set177 -o wide"
kubectl get pods -n=chp17-set177 -o wide
echo ""

kubectl describe pod/pod-with-prestop-hook -n=chp17-set177
echo ""
