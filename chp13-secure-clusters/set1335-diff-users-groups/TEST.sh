...
kubectl apply -f $FULLPATH/set1335-0-ns.yaml >> /dev/null
kubectl apply -f $FULLPATH/set1335-1-psp-privileged.yaml >> /dev/null
kubectl apply -f $FULLPATH/set1335-2-psp-default.yaml >> /dev/null
